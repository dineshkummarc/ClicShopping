...
- **Namespace**: `ClicShopping\AI\Agents\Orchestrator` → `ClicShopping\AI\Domains\Analytics\Agent`
...
- **Namespace**: `ClicShopping\AI\Agents\Orchestrator\SubAnalyticsAgent` → `ClicShopping\AI\Domains\Analytics\Agent`
...
- **Namespace**: `ClicShopping\AI\Tools\BIexecution` → `ClicShopping\AI\Domains\Analytics\Executor`
...
- **Namespace**: `ClicShopping\AI\Helper\Intent` → `ClicShopping\AI\Domains\Analytics\Processor`
...
- **Namespace**: `ClicShopping\AI\Handler\Error` → `ClicShopping\AI\Domains\Analytics\Helper`
