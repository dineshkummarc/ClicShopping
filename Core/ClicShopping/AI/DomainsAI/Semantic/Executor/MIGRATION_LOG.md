...
- **NEW**: `namespace ClicShopping\AI\DomainsAI\Semantic\Executor;`
...
1. `Core/ClicShopping/AI/Agents/Orchestrator/SubOrchestrator/HybridQueryProcessor.php`
   ...
   - To: `use ClicShopping\AI\DomainsAI\Semantic\Executor\SemanticQueryExecutor;`
...
The class uses:
- `ClicShopping\AI\DomainsAI\Semantic\Agent\SemanticAgent` (for search operations)
