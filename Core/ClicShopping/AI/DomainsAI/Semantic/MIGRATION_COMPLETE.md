...
- **Namespace**: `ClicShopping\AI\Helper\Intent` → `ClicShopping\AI\DomainsAI\Semantic\Processor`
...
- **Namespace**: `ClicShopping\AI\Helper\Detection` → `ClicShopping\AI\DomainsAI\Semantic\Helper`
