...
- **Namespace**: `ClicShopping\AI\Domain\Embedding` → `ClicShopping\AI\DomainsAI\CoreAI\Embedding`
...
- **Namespace**: `ClicShopping\AI\Domain\Embedding` → `ClicShopping\AI\DomainsAI\CoreAI\Embedding`
- **Internal Reference**: Updated `use ClicShopping\AI\Domain\Embedding\NewVector` → `use ClicShopping\AI\DomainsAI\CoreAI\Embedding\NewVector`
...
- **Namespace**: `ClicShopping\AI\Helper` → `ClicShopping\AI\DomainsAI\CoreAI\Entity`
...
- **Namespace**: `ClicShopping\AI\Helper` → `ClicShopping\AI\DomainsAI\CoreAI\Entity`
- **Internal Reference**: Updated `use ClicShopping\AI\Helper\EntityRegistry` → `use ClicShopping\AI\DomainsAI\CoreAI\Entity\EntityRegistry`
...
**Pattern**: `use ClicShopping\AI\Domain\Embedding\*` → `use ClicShopping\AI\DomainsAI\CoreAI\Embedding\*`
...
**Pattern**: 
- `use ClicShopping\AI\Helper\EntityHelper` → `use ClicShopping\AI\DomainsAI\CoreAI\Entity\EntityHelper`
- `use ClicShopping\AI\Helper\EntityRegistry` → `use ClicShopping\AI\DomainsAI\CoreAI\Entity\EntityRegistry`
- `use ClicShopping\AI\Helper\EntityIdExtractor` → `use ClicShopping\AI\DomainsAI\CoreAI\Entity\EntityIdExtractor`
