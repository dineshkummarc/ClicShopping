...
class FooterOutputBootstrapTable
{
  ...
  public function display(): string|bool
  {
    ...
    if (isset($_SESSION['admin'])) {
      ...
      $output .= '<script defer src="https://unpkg.com/bootstrap-table@1.27.1/dist/bootstrap-table.min.js"></script>' . "\n";
//checkbox
      $output .= '<script defer src="' . CLICSHOPPING::link('Shop/ext/javascript/bootstrapTable/table_checkbox.js') . '"></script>' . "\n";
//export
      $output .= '<script defer src="https://unpkg.com/bootstrap-table@1.27.1/dist/extensions/export/bootstrap-table-export.min.js"></script>' . "\n";
